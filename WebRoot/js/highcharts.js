...
(function(T, K) {
	...
	(function(a) {
		...
		a.Fx.prototype = {
			...
			update : function() {
				var a = this.elem,
					...
					e = this.now,
					u = this.options.step;
				if (this[h + "Setter"]) this[h + "Setter"]();else
					a.attr ? a.element && a.attr(h, e, null, !0) : a.style[h] = e + this.unit;
				u && u.call(a, e, this)
			},
			run : function(n, h, e) {
				var u = this,
				...
				this.prop] ? (this.startTime = +new Date, this.start = n, this.end = h, this.unit = e, this.now = this.start, this.pos = 0, q.elem = this.elem, q.prop = this.prop, q() && 1 === a.timers.push(q) && x(f)) : (
					delete y.curAnim[this.prop]
			...
			initPath : function(n, h, e) {
				...
				function y(a, d) {
					for (; a.length < l;) {
						a[0] = d[l - a.length];var c = a.slice(0, r);
						[].splice.apply(a, [ 0, 0 ].concat(c));v && (c = a.slice(a.length - r), [].splice.apply(a, [ a.length, 0 ].concat(c)), b--)
					}
					a[0] = "M"
				}
				function q(a, b) {
		...
		a.merge = function() {
			var n,
				...
				u = {},
				y = function(e, n) {
					"object" !== typeof e && (e = {});a.objectEach(n, function(f, c) {
		...
		a.createElement = function(n, h, e, u, y) {
			n = E.createElement(n);
			var q = a.css;
			h && a.extend(n, h);y && q(n, {
				padding : 0,
				border : "none",
				margin : 0
			});e && q(n, e);u && u.appendChild(n);return n
		};
		a.extendClass = function(n, h) {
			var e = function() {};
			e.prototype = new n;a.extend(e.prototype, h);return e
		};
		...
		a.wrap = function(a, h, e) {
			...
			a[h] = function() {
				...
				a = e.apply(this, a);
				x.proceed = null;return a
			}
		};
		a.formatSingle = function(n, h, e) {
			var u = /\.([0-9])/,
				y = a.defaultOptions.lang;
			/f$/.test(n) ? (e = (e = n.match(u)) ? e[1] : -1, null !== h && (h = a.numberFormat(h, e, y.decimalPoint, -1 < n.indexOf(",") ? y.thousandsSep : ""))) : h = (e || a.time).dateFormat(n, h);return h
		};
		a.format = function(n, h, e) {
			for (var u = "{", y = !1, q, x, f, c, k = [], r; n;) {
				...
				if (y) {
					...
					q.length && (r = a.formatSingle(q.join(":"), r, e));k.push(r)
				} else k.push(q);
				n = n.slice(u + 1);
				u = (y = !y) ? "}" : "{"
			}
		...
		a.normalizeTickInterval = function(n, h, e, u, y) {
			var q,
				x = n;
			e = a.pick(e, 1);
			q = n / e;h || (h = y ? [ 1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10 ] : [ 1, 2, 2.5, 5, 10 ], !1 === u && (1 === e ? h = a.grep(h, function(a) {
				return 0 === a % 1
			}) : .1 >= e && (h = [ 1 / e ])));
		...
		a.stableSort = function(a, h) {
			...
			a.sort(function(a, e) {
				n = h(a, e);return 0 === n ? a.safeI - e.safeI : n
			});
			for (y = 0; y < e; y++)
				delete a[y].safeI
		};
		...
		a.discardElement = function(n) {
			var h = a.garbageBin;
			h || (h = a.createElement("div"));n && h.appendChild(n);
			h.innerHTML = ""
		};
		...
		a.numberFormat = function(n, h, e, u) {
			...
			n += q.substr(x).replace(/(\d{3})(?=\d)/g, "$1" + u);h && (n += e + f.slice(-h));c[1] && 0 !== +n && (n += "e" + c[1]);return n
		};
		...
		a.addEvent = function(n, h, e, u) {
			...
			{} : n.hcEvents = n.hcEvents || {};a.Point && n instanceof a.Point && n.series && n.series.chart && (n.series.chart.runTrackerClick = !0);q && q.call(n, h, e, !1);y[h] || (y[h] = []);y[h].push(e);u && a.isNumber(u.order) && (e.order = u.order, y[h].sort(function(a, f) {
		...
		a.animate = function(n, h, e) {
			...
			e.curAnim = a.merge(h);a.objectEach(h, function(c, f) {
				a.stop(n, f);
				x = new a.Fx(n, e, f);
				q = null;
				"d" === f ? (x.paths = x.initPath(n, n.d, h.d), x.toD = h.d, u = 0, q = 1) : n.attr ? u = n.attr(f) : (u = parseFloat(a.getStyle(n, f)) || 0, "opacity" !== f && (y = "px"));q || (q = c);q && q.match && q.match("px") && (q = q.replace(/px/g, ""));x.run(u, q, y)
			})
		};
		a.seriesType = function(n, h, e, u, y) {
			...
			x[n].prototype.type = n;y && (x[n].prototype.pointClass = a.extendClass(a.Point, y));return x[n]
		};
		...
		C = a.SVGElement = function() {
			...
			animate : function(z, g, b) {
				...
				0 !== g.duration ? (b && (g.complete = b), n(this, z, g)) : (this.attr(z, null, b), g.step && g.step.call(this));return this
			},
			complexColor : function(z, g, b) {
				...
				a.fireEvent(this.renderer, "complexColor", {
					...
					z.radialGradient ? c = "radialGradient" : z.linearGradient && (c = "linearGradient");c && (l = z[c], f = d.gradients, B = z.stops, v = b.radialReference, I(l) && (z[c] = l = {
						x1 : l[0],
						y1 : l[1],
						x2 : l[2],
						y2 : l[3],
			...
			applyTextOutline : function(z) {
				...
				if ((c = z[0]) && "none" !== c && a.svg) {
					...
					l = g.firstChild;r(z, function(a, z) {
			...
			addClass : function(a, g) {
				...
				-1 === z.indexOf(a) && (g || (a = (z + (z ? " " : "") + a).replace("  ", " ")), this.attr("class", a));return this
			},
			hasClass : function(a) {
			...
			crisp : function(a, g) {
				...
				a.height = Math.floor((a.height || this.height || 0) - 2 * z);x(a.strokeWidth) && (a.strokeWidth = g);return a
			},
			css : function(a) {
				var z = this.styles,
					b = {},
					...
					J = [ "textOutline", "textOverflow",
						"width" ];
				a && a.color && (a.fill = a.color);z && M(a, function(a, g) {
					a !== z[g] && (b[g] = a, f = !0)
				});f && (z && (a = l(z, b)), a && (null === a.width || "auto" === a.width ?
					delete this.textWidth
					: "text" === d.nodeName.toLowerCase() && a.width && (w = this.textWidth = g(a.width))), this.styles = a, w && !Q && this.renderer.forExport &&
				delete a.width
				, d.namespaceURI === this.SVG_NS ? (m = function(a, z) {
			...
			on : function(a, g) {
				...
				v && "click" === a ? (b.ontouchstart = function(a) {
					z.touchEventFired = Date.now();a.preventDefault();g.call(b, a)
			...
			updateTransform : function() {
				...
				a = [ "translate(" + a + "," + g + ")" ];x(l) && a.push("matrix(" + l.join(",") +
					")");
			...
			align : function(a, g, b) {
				...
				c = (b.x || 0) + (a.x || 0);
				l = (b.y || 0) + (a.y || 0);
				"right" === z ? f = 1 : "center" === z && (f = 2);f && (c += (b.width - (a.width || 0)) / f);
				m[g ? "translateX" : "x"] = Math.round(c);
				"bottom" === w ? J = 1 : "middle" === w && (J = 2);J && (l += (b.height - (a.height || 0)) / J);
				m[g ? "translateY" : "y"] = Math.round(l);this[this.placed ? "animate" : "attr"](m);
				this.placed = !0;
				this.alignAttr = m;return this
			},
			getBBox : function(a,
				g) {
				var z,
				...
				g = G(g, this.rotation);
				d = g * f;
				m = c && c.fontSize;x(J) && (p = J.toString(), -1 === p.indexOf("\x3c") && (p = p.replace(/[0-9]/g, "0")), p += [ "", g || 0, m, this.textWidth, c && c.textOverflow ].join());p && !a && (z = k[p]);
				if (!z) {
			...
			add : function(a) {
				...
				this.parentInverted = a && a.inverted;void 0 !== this.textStr && z.buildText(this);
				this.added = !0;
			...
			destroy : function() {
				var a = this,
					...
					w = g.ownerSVGElement,
					c = a.clipPath;
				g.onclick = g.onmouseout = g.onmouseover = g.onmousemove = g.point = null;P(a);c && w && (r(w.querySelectorAll("[clip-path],[CLIP-PATH]"), function(a) {
				...
				a.safeRemoveChild(g);
				for (a.destroyShadows(); b && b.div && 0 === b.div.childNodes.length;) g = b.parentGroup, a.safeRemoveChild(b.div),
					delete b.div
					, b = g;
				a.alignTo && d(a.renderer.alignedObjects, a);M(a, function(g, z) {
					delete a[z]
				});return null
			},
			...
			dSetter : function(a, g, b) {
				a && a.join && (a = a.join(" "));/(NaN| {2}|^$)/.test(a) && (a = "M 0 0");this[g] !== a && (b.setAttribute(g, a), this[g] = a)
			},
		...
		E = a.SVGRenderer = function() {
			...
			init : function(a, g, b, d, w, c) {
				...
				z = d.element;a.appendChild(z);h(a, "dir", "ltr");-1 === a.innerHTML.indexOf("xmlns") && h(z, "xmlns", this.SVG_NS);
				this.isSVG = !0;
				this.box = z;
				this.boxWrapper = d;
				this.alignedObjects = [];
				this.url = (t || m) && k.getElementsByTagName("base").length ? N.location.href.replace(/#.*?$/, "").replace(/<[^>]*>/g, "").replace(/([\('\)])/g, "\\$1").replace(/ /g, "%20") : "";this.createElement("desc").add().element.appendChild(k.createTextNode("Created with Highcharts 6.1.1"));
				...
				this.cache = {};
				this.cacheKeys = [];
				this.imgCount = 0;this.setSize(g, b, !1);
				var l;
			...
			destroy : function() {
				var a = this.defs;
				this.box = null;
				this.boxWrapper = this.boxWrapper.destroy();c(this.gradients || {});
			...
			applyEllipsis : function(a, g, b, d) {
				var w = a.rotation,
					...
					m = b.length,
					J = function(a) {
						g.removeChild(g.firstChild);a && g.appendChild(k.createTextNode(a))
					},
					f;
				a.rotation = 0;
			...
			buildText : function(a) {
				var d = a.element,
					...
					H = function(a) {
						var b;
						b = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : O || w.style.fontSize || 12;return t ? g(t) : w.fontMetrics(b, a.getAttribute("style") ? a : d).h
					},
					N = function(a, g) {
						...
						l = g.split("|||");r(l, function(g) {
							if ("" !== g || 1 === l.length) {
								...
								if (" " !== g) {
									...
									z ? m.dx = 0 : b && null !== B && (m.x = B);h(v, m);d.appendChild(v);!z && x && (!Q && c && y(v, {
										display : "block"
									}), h(v, "dy", H(v)));
									if (D) {
			...
			button : function(a, g, b, d, w, c, m, f, J) {
				...
				z.setState = function(a) {
					1 !== a && (z.state = v = a);z.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass("highcharts-button-" + [ "normal", "hover", "pressed", "disabled" ][a || 0]);z.attr([ w, c, m, f ][a || 0]).css([ B, k, p, r ][a || 0])
				};z.attr(w).css(l({
					cursor : "default"
				}, B));return z.on("click", function(a) {
					3 !== v && d.call(z, a)
				})
			},
			...
			path : function(a) {
				...
				I(a) ? g.d = a : A(a) && l(g, a);return this.createElement("path").attr(g)
			},
			...
			symbol : function(a, g, b, d, w, c) {
				...
				B ? (f = this.path(p), f.attr("fill", "none"), l(f, {
					...
					f[a + "Setter"] = function(a, g) {
						...
						this[g] = a;x(d) && (this.element && this.element.setAttribute(g, d), this.alignByTranslate || (b[w] = ((this[g] || 0) - d) / 2, this.attr(b)))
					}
				}), x(g) && f.attr({
					x : g,
					y : b
					...
					onload : function() {
						...
						f.imgheight = this.height;f.element && t();this.parentNode && this.parentNode.removeChild(this);m.imgCount--;
			...
			symbols : {
				...
				arc : function(a, g, b, d, w) {
					...
					l = [ "M", a + l * J, g + m * v, "A", l, m, 0, w, 1, a + l * z, g + m * f ];x(b) && l.push(d ? "M" : "L", a + b * z, g + b * f, "A", b, b, 0, w, 0, a + b * J, g + b * v);l.push(d ? "" : "Z");return l
				},
				callout : function(a,
					g, b, d, w) {
			...
			text : function(a, g, b, d) {
				...
				w.x = Math.round(g || 0);b && (w.y = Math.round(b));
				if (a || 0 === a)
					w.text = a;
				a = this.createElement("text").attr(w);d || (a.xSetter = function(a, g, b) {
			...
			fontMetrics : function(a, b) {
				...
				b = 24 > a ? a + 3 : Math.round(1.2 * a);return {
					h : b,
					b : Math.round(.8 * b),
					f : a
				}
			...
			label : function(g, b, d, c, m, f, J, v, B) {
				...
				L = function() {
					...
					y = e + k.fontMetrics(a && a.fontSize, t).b;u && (z || (p.box = z = k.symbols[c] || M ? k.symbol(c) : k.rect(), z.addClass(("button" === B ? "" : "highcharts-label-box") + (B ? " highcharts-" + B + "-box" : "")), z.add(p), a = n(), g.x = a, g.y = (v ? -y : 0) + a), g.width = Math.round(p.width), g.height = Math.round(p.height), z.attr(l(g, H)), H = {})
				};
				R = function() {
					var a = P + e,
						g;
					g = v ? 0 : y;x(h) && A && ("center" === I || "right" === I) && (a += {
							center : .5,
							right : 1
						}[I] * (h - A.width));
				...
				p.textSetter = function(a) {
					void 0 !== a && t.textSetter(a);L();R()
				};
				p["stroke-widthSetter"] = function(a, g) {
					a && (u = !0);
					N = this["stroke-width"] = a;U(g, a)
				};
				p.strokeSetter = p.fillSetter = p.rSetter = function(a, g) {
					"r" !== g && ("fill" === g && a && (u = !0), p[g] = a);U(g, a)
				};
				p.anchorXSetter = function(a, g) {
					m = p.anchorX = a;U(g, Math.round(a) - n() - q)
				};
				p.anchorYSetter = function(a, g) {
					f = p.anchorY = a;U(g, a - G)
				};
				p.xSetter = function(a) {
					p.x = a;Q && (a -= Q * ((h || A.width) + 2 * e), p["forceAnimate:x"] = !0);
					q = Math.round(a);p.attr("translateX", q)
				};
				p.ySetter = function(a) {
					G = p.y = Math.round(a);p.attr("translateY", G)
				};
				var S = p.css;
				return l(p, {
					css : function(a) {
						if (a) {
							var g = {};
							a = D(a);r(p.textProps, function(b) {
								void 0 !== a[b] && (g[b] = a[b],
								delete a[b]
								)
							});t.css(g);"width" in g && L()
						}
						return S.call(p, a)
					},
					getBBox : function() {
					...
					shadow : function(a) {
						a && (L(), z && z.shadow(a));return p
					},
					destroy : function() {
						w(p.element, "mouseenter");w(p.element, "mouseleave");t && (t = t.destroy());z && (z = z.destroy());C.prototype.destroy.call(p);
						p = k = L = R = U = null
					}
				})
			}
		...
		e(a.SVGElement.prototype, {
			htmlCss : function(a) {
				...
				if (d = a && "SPAN" === d.tagName && a.width)
					delete a.width
					, this.textWidth = d, this.htmlUpdateTransform();
				a && "ellipsis" === a.textOverflow && (a.whiteSpace = "nowrap", a.overflow = "hidden");
				this.styles = e(this.styles, a);F(this.element, a);return this
			},
				...
				if (this.added) {
					...
					if ("SPAN" === d.tagName) {
						...
						B && /[ \-]/.test(d.textContent || d.innerText) ? (F(d, {
							...
							display : "block",
							whiteSpace : e || "normal"
						}), this.oldTextWidth = m, this.hasBoxWidthChanged = !0) : this.hasBoxWidthChanged = !1;D !== this.cTT && (e = a.fontMetrics(d.style.fontSize).b, n(A) && A !== (this.oldRotation || 0) && this.setSpanRotation(A, r, e), this.getSpanCorrection(!n(A) &&
							this.textPxLength || d.offsetWidth, e, r, A, t));F(d, {
			...
			setSpanRotation : function(a, d, b) {
				...
				c[l + (u ? "Origin" : "-origin")] = c.transformOrigin = 100 * d + "% " + b + "px";F(this.element, c)
			},
			...
			html : function(a, d, b) {
				...
				c.css = c.htmlCss;k && (c.add = function(a) {
					var b,
						d = f.box.parentNode,
						p = [];
					if (this.parentGroup = a) {
						...
						b = d;
					b.appendChild(l);
					c.added = !0;c.alignOnAdd && c.htmlUpdateTransform();return c
				});return c
			}
		})
	})(K);(function(a) {
		...
		a.Time.prototype = {
			...
			update : function(e) {
				...
				(this.variableTimezone = !(q && !e.getTimezoneOffset && !e.timezone)) || this.timezoneOffset ? (this.get = function(a, c) {
					...
					c.setTime(r);
					a = c["getUTC" + a]();c.setTime(f);return a
			...
			makeTime : function(e, q, x, f, c, k) {
				var r,
					l,
					d;
				this.useUTC ? (r = this.Date.UTC.apply(0, arguments), l = this.getTimezoneOffset(r), r += l, d = this.getTimezoneOffset(r), l !== d ? r += d - l : l - 36E5 !== this.getTimezoneOffset(r - 36E5) || a.isSafari || (r -= 36E5)) : r = (new this.Date(e, q, h(x, 1), h(f, 0), h(c, 0), h(k, 0))).getTime();return r
			},
			...
			getTimeTicks : function(a, q, x, f) {
				...
				if (C(q)) {
					c.set("Milliseconds", d, b >= e.second ? 0 : v * Math.floor(c.get("Milliseconds", d) / v));b >= e.second && c.set("Seconds", d, b >= e.minute ? 0 : v * Math.floor(c.get("Seconds", d) / v));b >= e.minute && c.set("Minutes", d, b >= e.hour ? 0 : v * Math.floor(c.get("Minutes", d) / v));b >= e.hour && c.set("Hours", d, b >= e.day ? 0 : v * Math.floor(c.get("Hours",
							d) / v));b >= e.day && c.set("Date", d, b >= e.month ? 1 : v * Math.floor(c.get("Date", d) / v));b >= e.month && (c.set("Month", d, b >= e.year ? 0 : v * Math.floor(c.get("Month", d) / v)), l = c.get("FullYear", d));b >= e.year && c.set("FullYear", d, l - l % v);b === e.week && c.set("Date", d, c.get("Date", d) - c.get("Day", d) + h(f, 1));
					l = c.get("FullYear", d);
					f = c.get("Month", d);
					var I = c.get("Date", d),
						t = c.get("Hours", d);
					q = d.getTime();c.variableTimezone && (p = x - q > 4 * e.month || c.getTimezoneOffset(q) !== c.getTimezoneOffset(x));
					d = d.getTime();
					for (q = 1; d < x;) k.push(d), d = b === e.year ? c.makeTime(l + q * v, 0) : b === e.month ? c.makeTime(l, f + q * v) : !p || b !== e.day && b !== e.week ? p && b === e.hour && 1 < v ? c.makeTime(l, f, I, t + q * v) : d + b * v : c.makeTime(l, f, I + q * v * (b === e.day ? 1 : 7)), q++;
					k.push(d);b <= e.hour && 1E4 > k.length && E(k, function(a) {
		...
		a.Tick = function(a, e, f, c) {
			...
			this.pos = e;
			this.type = f || "";
			this.isNewLabel = this.isNew = !0;f || c || this.addLabel()
		};
		a.Tick.prototype = {
			addLabel : function() {
				var a = this.axis,
				...
				if (E(c)) c && c.attr({
					...
					if (this.label = c = E(h) && l.enabled ? f.renderer.text(h, 0, 0, l.useHTML).css(e(l.style)).add(a.labelGroup) : null)
			...
			handleOverflow : function(a) {
				var e = this.axis,
					...
					H = {};
				if (b || !1 === f.overflow)
					0 > b && c - v * p < l ? A = Math.round(c / Math.cos(b * y) - l) : 0 < b && c + v * p > r && (A = Math.round((k - c) / Math.cos(b * y)));
				else if (k = c + (1 - v) * p, c - v * p < l ? t = a.x + t * (1 - v) - l : k > r && (t = r - a.x + t * v, q = -1), t = Math.min(h, t), t < h && "center" === e.labelAlign && (a.x += q * (h - t - v * (h - Math.min(p, t)))), p > t || e.autoRotation && (d.styles || {}).width)
					A = t;
			...
			getLabelPosition : function(a, e, f, c, k, r, l, d) {
				...
				e = e + q - (r && !c ? r * v * (p ? 1 : -1) : 0);h && (f = l / (d || 1) % h, b.opposite && (f = h - f - 1), e += b.labelOffset / h * f);
				x.x = a;
				x.y = Math.round(e);n(this, "afterGetLabelPosition", {
					pos : x
				});return x
			},
			...
			render : function(e, h, f) {
				...
				f = u(f, 1);
				this.isActive = !0;this.renderGridLine(h, f, c);this.renderMark(r, f, c);this.renderLabel(r, h, f, e);
				this.isNew = !1;a.fireEvent(this, "afterRender")
			},
			destroy : function() {
				F(this, this.axis)
			}
	...
	var V = function(a) {
		...
		a.extend(G.prototype, {
			...
			init : function(a, d) {
				...
				w.isXAxis = g;
				w.coll = w.coll || (g ? "xAxis" : "yAxis");k(this, "init", {
					userOptions : d
				});
				w.opposite = d.opposite;
				w.side = d.side || (w.horiz ? w.opposite ? 0 : 2 : w.opposite ? 1 : 3);w.setOptions(d);
				var c = this.options,
					m = c.type;
				...
				w.hasNames = "category" ===
					m || !0 === c.categories;
				w.categories = c.categories || w.hasNames;w.names || (w.names = [], w.names.keys = {});
				...
				w.series = w.series || [];a.inverted && !w.isZAxis && g && void 0 === w.reversed && (w.reversed = !0);A(d, function(a, g) {
					C(w, g, a)
				});
				w.lin2log = c.linearToLogConverter || w.lin2log;w.isLog && (w.val2lin = w.log2lin, w.lin2val = w.lin2log);k(this, "afterInit")
			},
			setOptions : function(a) {
				this.options = t(this.defaultOptions, "yAxis" === this.coll && this.defaultYAxisOptions,
					[ this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions ][this.side], t(u[this.coll], a));k(this, "afterSetOptions", {
					userOptions : a
				})
			},
			defaultLabelFormatter : function() {
				...
				void 0 === k && (k = 1E4 <= Math.abs(b) ? a.numberFormat(b, -1) : a.numberFormat(b, -1, void 0, ""));return k
			},
			getSeriesExtremes : function() {
				...
				k(this, "getSeriesExtremes", null, function() {
					...
					a.softThreshold = !a.isXAxis;a.buildStacks && a.buildStacks();f(a.series, function(g) {
						if (g.visible || !b.options.chart.ignoreHiddenSeries) {
							var w = g.options,
								c = w.threshold,
								m;
							a.hasVisibleSeries = !0;a.positiveValuesOnly && 0 >= c && (c = null);
							...
							else if (g.getExtremes(), m = g.dataMax, g = g.dataMin, y(g) && y(m) && (a.dataMin = Math.min(H(a.dataMin, g), g), a.dataMax = Math.max(H(a.dataMax, m), m)), y(c) && (a.threshold = c), !w.softThreshold || a.positiveValuesOnly)
								a.softThreshold = !1
						}
					})
				});
			...
			translate : function(a, b, d, c, m, l) {
				...
				m = (g.isOrdinal || g.isBroken || g.isLog && m) && g.lin2val;J || (J = g.transA);d && (w *= -1, f = g.len);g.reversed && (w *= -1, f -= w * (g.sector || g.len));
				b ? (a = (a * w + f - k) / J + c, m && (a = g.lin2val(a))) : (m && (a = g.val2lin(a)), a = p(c) ? w * (a - c) * J + f + w * k + (p(l) ? J * l : 0) : void 0);return a
			},
			...
			getPlotLinePath : function(a, b, d, c, m) {
				var g = this.chart,
					...
					f,
					J,
					k = d && g.oldChartHeight || g.chartHeight,
					v = d && g.oldChartWidth || g.chartWidth,
					e;
				f = this.transB;
				var B = function(a, g, b) {
					if (a < g || a > b)
						c ? a = Math.min(Math.max(g, a), b) : e = !0;
					return a
				};
			...
			getMinorTickPositions : function() {
				...
				if (k && k / c < a.len / 3)
					if (a.isLog) f(this.paddedTicks, function(g, b, d) {
						...
						m = m.concat(a.getTimeTicks(a.normalizeTimeTickInterval(c), p, l, b.startOfWeek));else
						for (b = p + (d[0] - p) % c; b <= l && b !== m[0]; b += c) m.push(b);
				0 !== m.length && a.trimTicks(m);return m
			},
			adjustForMinRange : function() {
				...
				this.isXAxis && void 0 === this.minRange && !this.isLog && (y(a.min) || y(a.max) ? this.minRange = null : (f(this.series, function(a) {
					...
					for (p = e = a.xIncrement ? 1 : v.length - 1; 0 < p; p--)
						if (k = v[p] - v[p - 1], void 0 === l || k < l)
							l = k
				}), this.minRange = Math.min(5 * l, this.dataMax - this.dataMin)));d - b < this.minRange && (m = this.dataMax - this.dataMin >= this.minRange, B = this.minRange, c = (B - d + b) / 2, c = [ b - c, H(a.min, b - c) ], m && (c[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), b = F(c), d = [ b + B,
			...
			nameToX : function(a) {
				var g = v(this.categories),
					...
					c = a.options.x,
					m;
				a.series.requireSorting = !1;y(c) || (c = !1 ===
				this.options.uniqueNames ? a.series.autoIncrement() : g ? b(a.name, d) : H(d.keys[a.name], -1));
				-1 === c ? g || (m = d.length) : m = c;void 0 !== m && (this.names[m] = a.name, this.names.keys[a.name] = m);return m
			},
			...
			setAxisTranslation : function(a) {
				...
				if (e || v || d) c = b.getClosest(), p ? (m = p.minPointOffset, l = p.pointRangePadding) : f(b.series, function(a) {
						...
						d = Math.max(d, g);b.single || (m = Math.max(m, I(a) ? 0 : g / 2), l = Math.max(l, "on" === a ? 0 : g))
					}), p = b.ordinalSlope && c ? b.ordinalSlope / c : 1, b.minPointOffset = m *= p, b.pointRangePadding = l *= p, b.pointRange = Math.min(d, g), e && (b.closestPointRange = c);
				a && (b.oldTransA = B);
				b.translationSlope = b.transA = B = b.options.staticScale || b.len / (g + l || 1);
				b.transB = b.horiz ? b.left : b.bottom;
				b.minPixelPadding = B * m;k(this, "afterSetAxisTranslation")
			},
			...
			setTickInterval : function(b) {
				...
				(g.min = Math.max(g.min, c.floor));p(c.ceiling) && (g.max = Math.min(g.max, c.ceiling));x && y(g.dataMin) && (I = I || 0, !y(M) && g.min < I && g.dataMin >= I ? g.min = I : !y(n) && g.max > I && g.dataMax <= I && (g.max = I));
				g.tickInterval = g.min === g.max || void 0 === g.min || void 0 === g.max ? 1 : t && !h && A === g.linkedParent.options.tickPixelInterval ? h = g.linkedParent.tickInterval : H(h, this.tickAmount ? (g.max - g.min) / Math.max(this.tickAmount - 1, 1) : void 0, G ? 1 : (g.max - g.min) * A / Math.max(g.len, A));B && !b && f(g.series, function(a) {
					a.processData(g.min !== g.oldMin || g.max !==
						g.oldMax)
				});g.setAxisTranslation(!0);g.beforeSetTickPositions && g.beforeSetTickPositions();g.postProcessTickInterval && (g.tickInterval = g.postProcessTickInterval(g.tickInterval));g.pointRange && !h && (g.tickInterval = Math.max(g.pointRange, g.tickInterval));
				b = H(c.minTickInterval, g.isDatetimeAxis && g.closestPointRange);!h && g.tickInterval < b && (g.tickInterval = b);v || m || h || (g.tickInterval = L(g.tickInterval, null, l(g.tickInterval), H(c.allowDecimals, !(.5 < g.tickInterval && 5 > g.tickInterval && 1E3 < g.max && 9999 > g.max)), !!this.tickAmount));
			...
			setTickPositions : function() {
				...
				this.paddedTicks = b.slice(0);this.trimTicks(b, m, l);this.isLinked || (this.single && 2 > b.length && (this.min -= .5, this.max += .5), d || c || this.adjustTickAmount());k(this, "afterSetTickPositions")
			},
			...
			getTickAmount : function() {
				...
				!y(a.tickInterval) && this.len < d && !this.isRadial && !this.isLog && a.startOnTick && a.endOnTick && (b = 2);!b && this.alignToOthers() && (b = Math.ceil(this.len /
						d) + 1);4 > b && (this.finalTickAmt = b, b = 5);
				this.tickAmount = b
			},
			...
			setScale : function() {
				...
				b = this.len !== this.oldAxisLength;f(this.series, function(b) {
			...
			getThreshold : function(a) {
				...
				null === a || -Infinity === a ? a = g : Infinity === a ? a = b : g > a ? a = g : b < a && (a = b);return this.translate(a, 0, 1, 0, 1)
			},
			...
			unsquish : function() {
				var a = this.options.labels,
					...
					r = function(a) {
						a /= m || 1;
						a = 1 < a ? Math.ceil(a) : 1;return e(a * d)
					};
				...
				this.autoRotation = t;
				this.labelRotation = H(l, p);return c
			},
			...
			renderUnsquish : function() {
				var a = this.chart,
					...
					h = 0,
					A;
				I(m.rotation) || (B.rotation = m.rotation || 0);f(d, function(a) {
					(a = c[a]) && a.label && a.label.textPxLength > h && (h = a.label.textPxLength)
				});
				this.maxLabelLength = h;
				if (this.autoRotation)
					h > v && h > e.h ? B.rotation = this.labelRotation :
			...
			addTitle : function(a) {
				...
				this.axisTitle || ((m = c.textAlign) || (m = (g ? {
					...
					align : m
				}).addClass("highcharts-axis-title").css(t(c.style)).add(this.axisGroup), this.axisTitle.isNew = !0);c.style.width || this.isRadial || this.axisTitle.css({
					width : this.len
			...
			getOffset : function() {
				...
				a.staggerLines = a.horiz && G.staggerLines;a.axisGroup || (a.gridGroup = d.g("grid").attr({
				...
				H(G.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && f(m, function(a) {
					...
					a.destroy();
					delete l[b]
				});h && h.text && !1 !== h.enabled && (a.addTitle(e), e && !1 !== h.reserveSpace && (a.titleOffset = t = a.axisTitle.getBBox()[p ? "height" : "width"], r = h.offset, D = y(r) ? 0 : H(h.margin, p ? 5 : 10)));a.renderLine();
				...
				D = Math.abs(I) + D;I && (D = D - d + q * (p ? H(G.y, a.tickRotCorr.y + 8 * q) : G.x));
			...
			getLinePath : function(a) {
				...
				g && (a *= -1);return b.renderer.crispLine([ "M", c ? this.left : m, c ? d :
			...
			renderMinorTick : function(a) {
				var b = this.chart.hasRendered && p(this.oldMin),
					d = this.minorTicks;
				d[a] || (d[a] = new M(this, a, "minor"));b && d[a].isNew && d[a].render(null, !0);d[a].render(null, !1, 1)
			},
			...
			render : function() {
				...
				b.overlap = !1;f([ t, r, D ], function(a) {
					A(a, function(a) {
						a.isActive = !1
					})
				});
				if (b.hasData() || l) b.minorTickInterval && !b.categories && f(b.getMinorTickPositions(), function(a) {
						...
						n = void 0 !== v[g + 1] ? v[g + 1] + I : b.max - I;0 === g % 2 && c < b.max && n <= b.max + (d.polar ? -I : I) && (D[c] || (D[c] = new a.PlotLineOrBand(b)), u = c + I, D[c].options = {
				...
				f([ t, r, D ], function(a) {
					...
					A(a, function(a, b) {
						...
						for (b = c.length; b--;) a[c[b]] && !a[c[b]].isActive && (a[c[b]].destroy(),
							delete a[c[b]]
						)
					}, a !== D && d.hasRendered && g ? g : 0)
				});x && (x[x.isPlaced ? "animate" : "attr"]({
					d : this.getLinePath(x.strokeWidth())
				}), x.isPlaced = !0, x[q ? "show" : "hide"](!0));e && q && (c = b.getTitlePosition(), p(c.y) ? (e[e.isNew ?
					"attr" : "animate"](c), e.isNew = !1) : (e.attr("y", -9999), e.isNew = !0));h && h.enabled && b.renderStackTotals();
				b.isDirty = !1;k(this, "afterRender")
			},
			redraw : function() {
			...
			drawCrosshair : function(a, b) {
				...
				if (this.crosshair && !1 !== (y(b) || !g)) {
					g ? y(b) && (m = H(b.crosshairPos, this.isXAxis ? b.plotX : this.len - b.plotY)) : m = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos);y(m) && (d = this.getPlotLinePath(b && (this.isXAxis ? b.x : H(b.stackY, b.y)), null, null, null, m) || null);
					if (!y(d)) {
						this.hideCrosshair();return
					}
					g = this.categories && !this.isRadial;l || (this.cross = l = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (g ? "category " : "thin ") + c.className).attr({
						zIndex : H(c.zIndex,
							2)
					}).add(), l.attr({
	...
	(function(a) {
		...
		C.prototype.normalizeTimeTickInterval = function(a, e) {
			...
			a = F(a / y, q, "year" === e[0] ? Math.max(E(a / y), 1) : 1);return {
				unitRange : y,
				count : a,
				unitName : e[0]
			}
		...
		C.prototype.getLogTickPositions = function(a, u, y, q) {
			...
			if (.5 <= a) a = Math.round(a), c = this.getLinearTickPositions(a, u, y);
				...
				for (var f = Math.floor(u), k, r, l, d, b, e = .3 < a ? [ 1, 2, 4 ] : .15 < a ? [ 1, 2, 4, 6, 8 ] : [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ]; f < y + 1 && !b; f++)
					for (r = e.length, k = 0; k < r && !b; k++) l = this.log2lin(this.lin2log(f) * e[k]), l > u && (!q || d <= y) && void 0 !== d && c.push(d), d > y && (b = !0), d = l;
			...
			q || (this.tickInterval = a);return c
		};
		...
		a.PlotLineOrBand.prototype = {
			render : function() {
				...
				B.zIndex = m;
				G += "-" + m;(H = f.plotLinesAndBandsGroups[G]) || (f.plotLinesAndBandsGroups[G] = H = M.g("plot-" + G).attr(B).add());u && (e.svgElem = t = M.path().attr(A).add(H));
				if (h)
					A = f.getPlotLinePath(v, t.strokeWidth());
				else if (p)
					A = f.getPlotBandPath(b, d, k);else return;
				u && A && A.length ? (t.attr({
					d : A
				...
				r && n(r.text) && A && A.length && 0 < f.width && 0 < f.height && !A.isFlat ? (r = y({
					...
					y : c ? p ? 16 : 10 : p ? 6 : -4,
					rotation : c && !p && 90
				}, r), this.renderLabel(r, A, p, m)) : l && l.hide();return e
			},
			...
			addPlotBandOrLine : function(e, f) {
				var c = (new a.PlotLineOrBand(this, e)).render(),
					k = this.userOptions;
				c && (f && (k[f] = k[f] || [], k[f].push(e)), this.plotLinesAndBands.push(c));return c
			},
		...
		a.Tooltip.prototype = {
			...
			move : function(c, f, e, l) {
				...
				});d.getLabel().attr(b);v && (a.clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() {
					d && d.move(c, f, e, l)
				}, 32))
			},
			hide : function(c) {
				...
				c = y(c, this.options.hideDelay, 500);this.isHidden || (this.hideTimer = x(function() {
			...
			getAnchor : function(a, f) {
				var c,
					...
					h;
				a = q(a);
				c = a[0].tooltipPos;this.followPointer && f && (void 0 ===
				f.chartX && (f = l.pointer.normalize(f)), c = [ f.chartX - l.plotLeft, f.chartY - b ]);c || (E(a, function(a) {
					t = a.series.yAxis;
					h = a.series.xAxis;
					p += a.plotX + (!d && h ? h.left - v : 0);
					k += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!d && t ? t.top - b : 0)
				}), p /= a.length, k /= a.length, c = [ d ? l.plotWidth - k : p, this.shared && !d && 1 < a.length && f ? f.chartY - b : d ? l.plotHeight - p : k ]);return e(c, Math.round)
			},
			getPosition : function(a, f, e) {
				var c = this.chart,
					...
					B = function(a, c, g, m, l, f) {
						...
						if (D && e)
							...
							b[a] = Math.min(f - g, 0 > B - v ? B : B - v);
						else if (e)
							b[a] = Math.max(l, m + v + g > c ? m : m + v);else return !1
					},
					q = function(a, c, g, m) {
						var l;
						m < d || m > c - d ? l = !1 : b[a] = m < g / 2 ? 1 : m > c - g / 2 ? c - g - 2 : m - g / 2;return l
					},
					G = function(a) {
						var b = r;
						r = m;
				...
				(c.inverted || 1 < this.len) && G();g();return b
			},
			defaultFormatter : function(a) {
				var c = this.points || q(this),
					f;
				f = [ a.tooltipFooterHeaderFormatter(c[0]) ];
				f = f.concat(a.bodyFormatter(c));f.push(a.tooltipFooterHeaderFormatter(c[0],
					!0));return f
			},
			refresh : function(c, f) {
				...
				l.enabled && (a.clearTimeout(this.hideTimer), this.followPointer = q(b)[0].series.tooltipOptions.followPointer, v = this.getAnchor(b, f), f = v[0], d = v[1], !p || b.series && b.series.noSharedTooltip ? p = b.getLabelConfig() : (E(b, function(a) {
					...
					x : b[0].category,
					y : b[0].y
				}, p.points = k, b = b[0]), this.len = k.length, p = e.call(p, this), t = b.series, this.distance = y(t.tooltipOptions.distance, 16), !1 === p ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({
					opacity : 1
			...
			renderSplit : function(c, f) {
				var e = this,
					...
					k = 0,
					t = this.getLabel();
				a.isString(c) && (c = [ !1, c ]);E(c.slice(0, f.length + 1), function(a, c) {
					if (!1 !== a) {
						c = f[c - 1] || {
							isHeader : !0,
							plotX : f[0].plotX
						...
						c.isHeader ? (k = a.height, D = Math.max(0, Math.min(c.plotX + d.plotLeft - D / 2, d.chartWidth - D))) : D = c.plotX + d.plotLeft - y(p.distance, 16) - D;0 > D && (v = !1);
				...
				a.distribute(l, d.plotHeight + k);E(l, function(a) {
					var b = a.point,
						c = b.series;
					a.tt.attr({
			...
			updatePosition : function(a) {
				...
				a = a.plotY + c.plotTop;
				var b;
				this.outside && (b = (this.options.borderWidth || 0) + 2 * this.distance, this.renderer.setSize(f.width + b, f.height + b, !1), d += c.pointer.chartPosition.left - l.x, a += c.pointer.chartPosition.top - l.y);this.move(Math.round(l.x), Math.round(l.y || 0), d, a)
			},
		...
		a.Pointer.prototype = {
			init : function(a, c) {
				...
				this.pinchDown = [];
				this.lastValidTouch = {};d && (a.tooltip = new d(a, c.tooltip), this.followTouchMove = r(c.tooltip.followTouchMove, !0));this.setDOMEvents()
			},
			...
			normalize : function(a, c) {
				var b;
				b = a.touches ? a.touches.length ? a.touches.item(0) : a.changedTouches[0] : a;c || (this.chartPosition = c = k(this.chart.container));return y(a, {
			...
			getHoverData : function(b, d, f, l, e, k, h) {
				...
				d = (p = l ? b : this.findNearestKDPoint(h, e, k)) && p.series;p && (e && !d.noSharedTooltip ? (h = a.grep(f, function(a) {
			...
			runPointActions : function(b, d) {
				...
				if (e && (e !== c.hoverPoint || f && f.isHidden)) {
					...
					c.hoverPoints = h;
					c.hoverPoint = e;f && f.refresh(l ? h : e, b)
			...
			reset : function(a,
				...
				if (a) k && h && (k.refresh(h), f && (f.setState(f.state, !0), u(b.axes, function(a) {
					...
					if (d) d.onMouseOut();
					k && k.hide(c);this.unDocMouseMove && (this.unDocMouseMove = this.unDocMouseMove());u(b.axes, function(a) {
						a.hideCrosshair()
					});
			...
			drop : function(a) {
				...
				if (this.selectionMarker) {
					...
					f(c.index) && (this.selectionMarker = this.selectionMarker.destroy());d && this.scaleGroups()
				}
			...
			onDocumentMouseMove : function(a) {
				...
				a = this.normalize(a, c);!c || this.inClass(a.target, "highcharts-tracker") || b.isInsidePlot(a.chartX -
			...
			onContainerMouseMove : function(b) {
				...
				b = this.normalize(b);
				b.returnValue = !1;"mousedown" === c.mouseIsDown && this.drag(b);!this.inClass(b.target, "highcharts-tracker") && !c.isInsidePlot(b.chartX - c.plotLeft,
			...
			onContainerClick : function(a) {
				var b = this.chart,
					...
					d = b.plotLeft,
					f = b.plotTop;
				a = this.normalize(a);b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (x(c.series, "click", y(a, {
					point : c
			...
			setDOMEvents : function() {
				...
				this.unbindContainerMouseLeave = C(c, "mouseleave", b.onContainerMouseLeave);a.unbindDocumentMouseUp || (a.unbindDocumentMouseUp = C(d, "mouseup", b.onDocumentMouseUp));a.hasTouch && (c.ontouchstart = function(a) {
			...
			destroy : function() {
				var b = this;
				b.unDocMouseMove && b.unDocMouseMove();this.unbindContainerMouseLeave();a.chartCount || (a.unbindDocumentMouseUp &&
				(a.unbindDocumentMouseUp = a.unbindDocumentMouseUp()), a.unbindDocumentTouchEnd && (a.unbindDocumentTouchEnd = a.unbindDocumentTouchEnd()));clearInterval(b.tooltipTimeout);a.objectEach(b, function(a, c) {
					b[c] = null
				})
			}
		}
		...
		F(a.Pointer.prototype, {
			pinchTranslate : function(a, e, h, n, f, c) {
				this.zoomHor && this.pinchTranslateDirection(!0, a, e, h, n, f, c);this.zoomVert && this.pinchTranslateDirection(!1, a, e, h, n, f, c)
			},
			pinchTranslateDirection : function(a,
				...
				w ? (M -= .8 * (M - k[d][0]), D || (g -= .8 * (g - k[d][1])), h()) : k[d] = [ M, g ];y || (c[d] = u - q, c[p] = t);
				c = y ? 1 / A : A;
				f[p] = t;
				f[d] = e;
			...
			pinch : function(a) {
				var u = this,
					...
					v = {};
				1 < c && (u.initiated = !0);r && u.initiated && !b && a.preventDefault();n(f, function(a) {
				...
				"touchstart" === a.type ? (E(f, function(a, b) {
					...
					destroy : h,
					touch : !0
				}, q.plotBox)), u.pinchTranslate(x, f, d, l, v, k), u.hasPinched = r, u.scaleGroups(d, v), u.res && (u.res = !1, this.reset(!1, 0)))
			},
			touch : function(h, n) {
				var q = this.chart,
					u,
		...
		if (!a.hasTouch && (q.PointerEvent || q.MSPointerEvent)) {
			...
			x(u.prototype, "init", function(a, c, b) {
				a.call(this, c, b);this.hasZoom && F(c.container, {
				...
				this.batchMSEvents(y);a.call(this)
			})
		}
	})(K);(function(a) {
		var C = a.addEvent,
		...
		a.Legend.prototype = {
			...
			update : function(a, c) {
				var b = this.chart;
				this.setOptions(q(!0, this.options, a));this.destroy();
				b.isDirtyLegend = b.isDirtyBox = !0;x(c, !0) && b.redraw();e(this, "afterUpdate")
			},
			colorizeItem : function(a, c) {
				...
				d && d.css({
					...
					stroke : h
				});l && (r && l.isMarker && (q = a.pointAttribs(), c || (q.stroke = q.fill = k)), l.attr(q));e(this, "afterColorizeItem", {
					item : a,
					visible : c
				})
			},
			positionItems : function() {
				h(this.allItems, this.positionItem, this);this.chart.isResizing || this.positionCheckboxes()
			},
			...
			proximatePositions : function() {
				...
				h(this.allItems, function(f) {
					var e,
						l;
					e = b;f.xAxis && f.points && (f.xAxis.options.reversed && (e = !e), e = a.find(e ? f.points : f.points.slice(0).reverse(), function(b) {
				...
				}, this);a.distribute(d, c.plotHeight);h(d, function(a) {
			...
			render : function() {
				...
				this.lastItemY = this.offsetWidth = 0;b || (this.group = b = d.g("legend").attr({
					zIndex : 7
				}).add(), this.contentGroup = d.g().attr({
					zIndex : 1
				}).add(b), this.scrollGroup = d.g().add(this.contentGroup));this.renderTitle();
				f = this.getAllItems();c(f, function(a, b) {
					return (a.options && a.options.legendIndex || 0) - (b.options && b.options.legendIndex || 0)
				});n.reversed && f.reverse();
				this.allItems = f;
				this.display = e = !!f.length;
				this.itemHeight = this.totalItemWidth = this.maxItemWidth = this.lastLineHeight = 0;h(f, this.renderItem, this);h(f, this.layoutItem, this);
				f = (n.width || this.offsetWidth) + A;
				k = this.lastItemY + this.lastLineHeight + this.titleHeight;
				k = this.handleOverflow(k);
				k += A;r || (this.box = r = d.rect().addClass("highcharts-legend-box").attr({
					r : n.borderRadius
				}).add(b),
				r.isNew = !0);r.attr({
				...
				}).shadow(n.shadow);0 < f && 0 < k && (r[r.isNew ? "attr" : "animate"](r.crisp.call({}, {
					x : 0,
					y : 0,
					width : f,
					height : k
				}, r.strokeWidth())), r.isNew = !1);r[e ? "show" : "hide"]();
				this.legendWidth = f;
				this.legendHeight = k;e && (d = a.spacingBox, /(lth|ct|rth)/.test(this.getAlignment()) && (d = q(d, {
			...
			handleOverflow : function(a) {
				var c = this,
					...
					w = function(a) {
						"number" === typeof a ? A.attr({
							height : a
						}) : A && (c.clipRect = A.destroy(), c.contentGroup.clip());c.contentGroup.div && (c.contentGroup.div.style.clip = a ? "rect(" + k + "px,9999px," + (k + a) + "px,0)" : "auto")
					};
				"horizontal" !== e.layout || "middle" === e.verticalAlign || e.floating || (b /= 2);l && (b = Math.min(b, l));
				n.length = 0;
				a > b && !1 !== q.enabled ? (this.clipHeight = r = Math.max(b - 20 - this.titleHeight - k, 0), this.currentPage = x(this.currentPage, 1), this.fullHeight = a, h(g, function(a, b) {
					...
					a.pageIx = f - 1;G && (g[b - 1].pageIx = f - 1);b === g.length - 1 && c + d - n[f - 1] > r && (n.push(c), a.pageIx = f);c !== G && (G = c)
				}), A || (A = c.clipRect = f.clipRect(0, k, 9999, 0), c.contentGroup.clip(A)), w(r), B || (this.nav = B = f.g().attr({
					zIndex : 1
			...
			scroll : function(a, c) {
				...
				var e = this.clipHeight,
					...
					k = this.pager,
					h = this.padding;
				a > d && (a = d);0 < a && (void 0 !== c && f(c, this.chart), this.nav.attr({
					translateX : h,
		...
		a.LegendSymbolMixin = {
			...
			drawLineMarker : function(a) {
				...
				this.legendLine = l.path([ "M", 0, a, "L", f, a ]).addClass("highcharts-graph").attr(r).add(h);b && !1 !== b.enabled && f &&
		...
		a.chart = function(a, b, c) {
			...
			init : function(b, c) {
				...
				d(this, "init", {
					...
					var h = this;
					h.index = x.length;x.push(h);a.chartCount++;l && H(l, function(a, b) {
						C(h, b, a)
					});
					h.xAxis = [];
					h.yAxis = [];
					h.pointCount = h.colorCounter = h.symbolCounter = 0;d(h, "afterInit");h.firstRender()
				})
			},
			initSeries : function(b) {
				var c = this.options.chart;
				(c = G[b.type || c.type || c.defaultSeriesType]) || a.error(17, !0);
				c = new c;c.init(this, b);return c
			},
			...
			redraw : function(b) {
				...
				var c = this.axes,
					...
					t = p.isHidden(),
					G = [];
				this.setResponsive && this.setResponsive(!1);a.setAnimation(b, this);t && this.temporaryDisplay();this.layOutTitles();
				for (b = g.length; b--;)
				...
				k(g, function(a) {
					a.isDirty && "point" === a.options.legendType && (a.updateTotals && a.updateTotals(), e = !0);a.isDirtyData && d(a, "updatedData")
				});e && m.options.enabled && (m.render(), this.isDirtyLegend = !1);l && this.getStacks();B && k(c, function(a) {
					a.updateNames();a.setScale()
				});this.getMargins();B && (k(c, function(a) {
					a.isDirty && (D = !0)
				}), k(c, function(a) {
					var b = a.min + "," + a.max;
				...
				}));D && this.drawChartBox();d(this, "predraw");k(g, function(a) {
					(D || a.isDirty) && a.visible && a.redraw();
					a.isDirtyData = !1
				});f && f.reset(!0);p.draw();d(this, "redraw");d(this, "render");t && this.temporaryDisplay(!0);k(G, function(a) {
					a.call()
				})
			},
			get : function(a) {
			...
			getAxes : function() {
				var a = this,
					...
					c = b.xAxis = g(b.xAxis || {}),
					b = b.yAxis = g(b.yAxis || {});
				d(this, "getAxes");k(c, function(a, b) {
					a.index = b;
					a.isX = !0
				});k(b, function(a, b) {
					a.index = b
			...
			setTitle : function(a, b, c) {
				...
				}, g.subtitle, b);k([ [ "title", a, f ], [ "subtitle", b, g ] ], function(a, b) {
					var c = a[0],
						g = d[c],
						f = a[1];
					a = a[2];g && f && (d[c] = g = g.destroy());a && !g && (d[c] = d.renderer.text(a.text, 0, 0, a.useHTML).attr({
						align : a.align,
						"class" : "highcharts-" + c,
						zIndex : a.zIndex || 4
			...
			layOutTitles : function(a) {
				...
				this.titleOffset = b;!this.isDirtyBox && c && (this.isDirtyBox = this.isDirtyLegend = c, this.hasRendered &&
			...
			getChartSize : function() {
				var b = this.options.chart,
					...
					b = b.height,
					g = this.renderTo;
				c(d) || (this.containerWidth = a.getStyle(g, "width"));c(b) || (this.containerHeight = a.getStyle(g, "height"));
			...
			temporaryDisplay : function(b) {
				...
				if (b)
					for (; c && c.style;) c.hcOrigStyle && (a.css(c, c.hcOrigStyle),
						...
						), c.hcOrigDetached && (h.body.removeChild(c), c.hcOrigDetached = !1), c = c.parentNode;
				else
					for (; c && c.style;) {
			...
			getContainer : function() {
				...
				var e = a.uniqueKey(),
					k;
				b || (this.renderTo = b = g.renderTo);I(b) && (this.renderTo = b = h.getElementById(b));b || a.error(13, !0);
				f = B(n(b, "data-highcharts-chart"));v(f) && x[f] && x[f].hasRendered && x[f].destroy();n(b, "data-highcharts-chart", this.index);
				b.innerHTML = "";g.skipClone || b.offsetWidth || this.temporaryDisplay();this.getChartSize();
				f = this.chartWidth;
				m = this.chartHeight;
				k = r({
					position : "relative",
				...
				this.renderer = new (a[g.renderer] || a.Renderer)(b, f, m, null, g.forExport, c.exporting && c.exporting.allowHTML);this.setClassName(g.className);this.renderer.setStyle(g.style);
				this.renderer.chartIndex = this.index;d(this, "afterGetContainer")
			},
			getMargins : function(a) {
				var b = this.spacing,
					g = this.margin,
					f = this.titleOffset;
				this.resetMargins();f && !c(g[0]) && (this.plotTop = Math.max(this.plotTop, f + this.options.title.margin + b[0]));this.legend && this.legend.display && this.legend.adjustMargins(g, b);d(this, "getMargins");a || this.getAxisMargins()
			},
			...
			setSize : function(b, c, g) {
				var m = this,
					e = m.renderer;
				m.isResizing += 1;a.setAnimation(g, m);
				m.oldChartHeight = m.chartHeight;
				m.oldChartWidth = m.chartWidth;void 0 !== b && (m.options.chart.width = b);void 0 !== c && (m.options.chart.height = c);m.getChartSize();
				b = e.globalAnimation;(b ? E : f)(m.container, {
					width : m.chartWidth + "px",
					height : m.chartHeight + "px"
				}, b);m.setChartSize(!0);e.setSize(m.chartWidth, m.chartHeight, g);k(m.axes, function(a) {
					a.isDirty = !0;a.setScale()
				});
				m.isDirtyLegend = !0;
				m.isDirtyBox = !0;m.layOutTitles();m.getMargins();m.redraw(g);
				m.oldChartHeight = null;d(m, "resize");w(function() {
			...
			drawChartBox : function() {
				...
				v = "animate";m || (v = "attr", this.plotBackground = m = b.rect().addClass("highcharts-plot-background").add());m[v](A);m.attr({
					fill : B || "none"
				}).shadow(a.plotShadow);D && (l ? l.animate(A) : this.plotBGImage = b.image(D, w, p, t, G).add());
				n ? n.animate({
					width : q.width,
					height : q.height
				}) : this.clipRect = b.clipRect(q);
				v = "animate";e || (v = "attr", this.plotBorder = e = b.rect().addClass("highcharts-plot-border").attr({
					zIndex : 1
				}).add());e.attr({
				...
				this.isDirtyBox = !1;d(this, "afterDrawChartBox")
			},
			...
			render : function() {
				var a = this.axes,
					...
					f;
				this.setTitle();
				this.legend = new t(this, c.legend);this.getStacks && this.getStacks();this.getMargins(!0);this.setChartSize();
				c = this.plotWidth;
				d = this.plotHeight = Math.max(this.plotHeight - 21, 0);k(a, function(a) {
					a.setScale()
				});this.getAxisMargins();
			...
			addCredits : function(a) {
				var b = this;
				a = A(!0, this.options.credits, a);a.enabled && !this.credits && (this.credits = this.renderer.text(a.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function() {
					a.href &&
			...
			destroy : function() {
				var b = this,
					...
					e = f && f.parentNode;
				d(b, "destroy");
				b.renderer.forExport ? a.erase(x, b) : x[b.index] = void 0;a.chartCount--;b.renderTo.removeAttribute("data-highcharts-chart");M(b);
				...
				});f && (f.innerHTML = "", M(f), e && q(f));H(b, function(a, c) {
					delete b[c]
				})
			},
			firstRender : function() {
				...
				if (!a.isReadyToRender || a.isReadyToRender()) {
					...
					k(b.series || [], function(b) {
						a.initSeries(b)
					});a.linkSeries();d(a, "beforeRender");m && (a.pointer = new m(a, b));a.render();
			...
			onload : function() {
				...
				}, this);d(this, "load");d(this, "render");c(this.index) && this.setReflow(this.options.chart.reflow);
				this.onload = null
			}
		})
	})(K);(function(a) {
		...
		E.prototype.applyFixed = function() {
			...
			this.container.style.width = e + "px";this.renderer.boxWrapper.attr({
				width : e,
		...
		a.Point.prototype = {
			init : function(a, c, e) {
				this.series = a;
				this.color = a.color;this.applyOptions(c, e);
			...
			applyOptions : function(a, c) {
				...
				a = C.prototype.optionsToObject.call(this, a);F(this, a);
				this.options = this.options ? F(this.options, a) : a;a.group &&
				delete this.group;
				e && (this.y = this[e]);
				this.isNull = q(this.isValid && !this.isValid(), null === this.x || !y(this.y, !0));this.selected && (this.state = "select");"name" in this && void 0 === c && f.xAxis && f.xAxis.hasNames && (this.x = f.xAxis.nameToX(this));void 0 === this.x && f && (this.x = void 0 === c ? f.autoIncrement(this) : c);return this
			},
			setNestedProperty : function(f, c, e) {
				e = e.split(".");a.reduce(e, function(f, e, d, b) {
					f[e] = b.length - 1 === d ? c : a.isObject(f[e], !0) ? f[e] : {};return f[e]
				}, f);return f
			},
			...
			destroy : function() {
				var a = this.series.chart,
					c = a.hoverPoints,
					e;
				a.pointCount--;c && (this.setState(), n(c, this), c.length || (a.hoverPoints = null));
			...
			firePointEvent : function(a, c, e) {
				...
				(l.point.events[a] || f.options && f.options.events && f.options.events[a]) && this.importEvents();"click" === a && l.allowPointSelect && (e = function(a) {
		...
		a.Series = a.seriesType("line", null, {
			...
			init : function(a, b) {
				...
				d.linkedSeries = [];d.bindAxes();f(d, {
					name : b.name,
					state : "",
					visible : !1 !== b.visible,
					selected : !0 === b.selected
				});
				m = b.events;v(m, function(a, b) {
					C(d, b, a)
				});
				if (m && m.click || b.point && b.point.events && b.point.events.click || b.allowPointSelect)
					a.runTrackerClick = !0;
				d.getColor();d.getSymbol();q(d.parallelArrays, function(a) {
					d[a + "Data"] = []
				});d.setData(b.data, !1);d.isCartesian && (a.hasCartesianSeries = !0);e.length && (g = e[e.length - 1]);
				d._i = p(g && g._i, -1) + 1;a.orderSeries(this.insert(e));c(this, "afterInit")
			},
			insert : function(a) {
			...
			autoIncrement : function() {
				...
				this.pointInterval = c = p(this.pointInterval, a.pointInterval, 1);d && (a = new f.Date(b), "day" === d ? f.set("Date", a, f.get("Date", a) + c) : "month" === d ? f.set("Month", a, f.get("Month", a) + c) : "year" === d && f.set("FullYear", a, f.get("FullYear", a) + c), c = a.getTime() -
					b);
			...
			setOptions : function(a) {
				...
				this.stickyTracking = p(a.stickyTracking, h[this.type] && h[this.type].stickyTracking, h.series && h.series.stickyTracking,
					this.tooltipOptions.shared && !this.noSharedTooltip ? !0 : d.stickyTracking);null === g.marker &&
				delete d.marker;
			...
			getCyclic : function(a, b, c) {
				...
				b || (d = p(g[m], g["_" + m]), y(d) || (f.series.length || (f[e] = 0), g["_" + m] = d = f[e] % h, f[e] += 1), c && (b = c[d]));void 0 !== d && (this[m] = d);
				this[a] = b
			},
			getColor : function() {
			...
			updateData : function(b) {
				...
				q(b, function(b) {
					...
					g = a.defined(b) && this.pointClass.prototype.optionsToObject.call({
						series : this
					}, b).x;l(g) && (g = a.inArray(g, this.xData, e), -1 === g ? f.push(b) : b !== c.data[g] ? (d[g].update(b, !1, null, !1), d[g].touched = !0, h && (e = g)) : d[g] && (d[g].touched = !0), m = !0)
				}, this);
				if (m)
			...
			setData : function(b, c, f, e) {
				...
				b = b || [];
				k = b.length;
				c = p(c, !0);!1 !== e && k && h && !m.cropped && !m.hasGroupedData && m.visible && (H = this.updateData(b));
				if (!H) {
					m.xIncrement = null;
					m.colorCounter = 0;q(this.parallelArrays, function(a) {
						m[a + "Data"].length = 0
					});
					if (n && k > n) {
			...
			generatePoints : function() {
				var a = this.options,
					...
					n = [],
					A;
				c || p || (c = [], c.length = b.length, c = this.data = c);a && p && (this.options.keys = !1);
			...
			getExtremes : function(a) {
				...
				d = a.length;
				for (A = 0; A < d; A++)
					if (k = c[A], t = a[A], h = (l(t, !0) || r(t)) && (!b.positiveValuesOnly || t.length || 0 < t), k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[A + p] || k) >= m && (c[A - p] || k) <= e, h && k)
						if (h = t.length)
			...
			translate : function() {
				...
				var a = this.options,
					...
					x,
					I = Number.MAX_VALUE;
				"between" === t && (t = .5);l(t) && (t *= p(a.pointRange || d.pointRange));
				for (a = 0; a < k; a++) {
					var L = g[a],
						C = L.x,
						E = L.y;
					u = L.low;var F = b && e.stacks[(this.negStacks && E < (q ? 0 : n) ? "-" : "") + this.stackKey],
						K;
					e.positiveValuesOnly && null !== E && 0 >= E && (L.isNull = !0);
					L.plotX = v = h(Math.min(Math.max(-1E5, d.translate(C, 0, 0, 0, 1, t, "flags" === this.type)), 1E5));b && this.visible && !L.isNull && F && F[C] && (x = this.getStackIndicator(x, C, this.index), K = F[C], E = K.points[x.key],
					...
					L.yBottom = y(u) ? Math.min(Math.max(-1E5, e.translate(u, 0, 1, 0, 1)), 1E5) : null;r && (E = this.modifyValue(E, L));
					...
					L.clientX = A ? h(d.translate(C,
						0, 0, 0, 1, t)) : v;
					L.negative = L.y < (n || 0);
					L.category = f && void 0 !== f[L.x] ? f[L.x] : L.x;L.isNull || (void 0 !== H && (I = Math.min(I, Math.abs(v - H))), H = v);
			...
			setClip : function(a) {
				var b = this.chart,
					...
					g = this.clipBox,
					e = g || b.clipBox,
					m = this.sharedClipKey ||
					[ "_sharedClip", a && a.duration, a && a.easing, e.height, c.xAxis, c.yAxis ].join(),
					h = b[m],
					l = b[m + "m"];
				h || (a && (e.width = 0, f && (e.x = b.plotSizeX), b[m + "m"] = l = d.clipRect(f ? b.plotSizeX + 99 : -99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), b[m] = h = d.clipRect(e), h.count = {
					length : 0
				});a && !h.count[this.index] && (h.count[this.index] = !0, h.count.length += 1);!1 !== c.clip && (this.group.clip(a || g ? h : b.clipRect), this.markerGroup.clip(l), this.sharedClipKey = m);a || (h.count[this.index] && (
			...
			afterAnimate : function() {
				this.setClip();c(this, "afterAnimate");
			...
			markerAttribs : function(a, b) {
				...
				a.hasImage = f && 0 === f.indexOf("url");a.hasImage && (g = 0);
				a = {
					x : Math.floor(a.plotX) - g,
					y : a.plotY - g
				};g && (a.width = a.height = 2 * g);return a
			},
			pointAttribs : function(a,
				...
				g = f.lineColor || c.lineColor || g;b && (c = c.states[b], b = f.states && f.states[b] || {}, d = p(b.lineWidth, c.lineWidth, d + p(b.lineWidthPlus, c.lineWidthPlus, 0)), a = b.fillColor || c.fillColor || a, g = b.lineColor || c.lineColor || g);return {
					stroke : g,
					"stroke-width" : d,
					fill : a
				}
			...
			destroy : function() {
				var b = this,
					...
					l,
					k;
				c(b, "destroy");I(b);q(b.axisTypes || [], function(a) {
					(k = b[a]) && k.series && (x(k.series, b), k.isDirty = k.forceRedraw = !0)
				});b.legendItem && b.chart.legend.destroyItem(b);
				for (h = g.length; h--;) (l = g[h]) && l.destroy && l.destroy();
				b.points = null;a.clearTimeout(b.animationTimeout);v(b, function(a, b) {
					a instanceof L && !a.survive && (e = f && "group" === b ? "hide" : "destroy", a[e]())
				});d.hoverSeries === b && (d.hoverSeries = null);x(d.series, b);d.orderSeries();v(b, function(a, c) {
					delete b[c]
				})
			},
			getGraphPath : function(a, b,
				...
				var d = this,
					...
					h = [],
					l;
				a = a || d.points;(e = a.reversed) && a.reverse();(g = {
						right : 1,
						center : 2
					}[g] || g && 3) && e && (g = 4 - g);!f.connectNulls || b || c || (a = this.getValidPoints(a));q(a, function(e, k) {
					var p = e.plotX,
						r = e.plotY,
						t = a[k - 1];
			...
			drawGraph : function() {
				...
				q(d, function(d, f) {
					...
					}, d[3] ? e.dashstyle = d[3] : "square" !== b.linecap && (e["stroke-linecap"] = e["stroke-linejoin"] = "round"), e = a[g].attr(e).shadow(2 > f && b.shadow));e && (e.startX = c.xMap, e.isArea = c.isArea)
				})
			},
			...
			applyZones : function() {
				...
				d.length && (l || k) && t && void 0 !== t.min && (n = t.reversed, u = t.horiz, l && !this.showLine && l.hide(), k && k.hide(), A = t.getExtremes(), q(d, function(d, m) {
					...
					g = Math.min(Math.max(Math.round(t.toPixels(p(d.value, A.max), !0)), 0), r);I && (f = g = t.toPixels(A.max));
					H = Math.abs(f - g);
					y = Math.min(f, g);
					x = Math.max(f, g);
					t.isXAxis ? (h = {
						...
						width : r,
						height : H
					}, u && (h.y = b.plotWidth - h.y));v && c.isVML && (h = t.isXAxis ? {
						x : 0,
						y : n ? y : x,
						height : h.width,
						width : b.chartWidth
					...
					I = d.value > A.max;a.resetZones && 0 === g && (g = void 0)
				}), this.clips = e)
			},
			...
			plotGroup : function(a, b, c, d, f) {
				...
				e && (this[a] = g = this.chart.renderer.g().attr({
					zIndex : d || .1
				}).add(f));g.addClass("highcharts-" + b + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (y(this.colorIndex) ? "highcharts-color-" +
					this.colorIndex + " " : "") + (this.options.className || "") + (g.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), !0);g.attr({
					visibility : c
				})[e ? "attr" : "animate"](this.getPlotBox());return g
			},
			getPlotBox : function() {
				var a = this.chart,
					b = this.xAxis,
					c = this.yAxis;
				a.inverted && (b = c, c = this.xAxis);return {
			...
			render : function() {
				...
				a.markerGroup = a.plotGroup("markerGroup", "markers", g, h, k);e && a.animate(!0);
				d.inverted = a.isCartesian ? r : !1;a.drawGraph && (a.drawGraph(), a.applyZones());a.drawDataLabels && a.drawDataLabels();a.visible && a.drawPoints();a.drawTracker && !1 !== a.options.enableMouseTracking && a.drawTracker();a.invertGroups(r);!1 === f.clip || a.sharedClipKey || l || d.clip(b.clipRect);e && a.animate();l || (a.animationTimeout = A(function() {
					a.afterAnimate()
				},
					e));
				a.isDirty = !1;
				a.hasRendered = !0;c(a, "afterRender")
			},
			redraw : function() {
				var a = this.chart,
			...
			searchKDTree : function(a, b) {
				function c(a, b, h, m) {
					...
					k = a[k] - l[k];
					r = 0 > k ? "left" : "right";
					p = 0 > k ? "right" : "left";b[r] && (r = c(a, b[r], h + 1, m), t = r[e] < t[e] ? r : l);b[p] && Math.sqrt(k * k) < t[e] && (a = c(a, b[p], h + 1, m), t = a[e] < t[e] ? a : t);return t
				}
				var d = this,
					f = this.kdAxisArray[0],
					g = this.kdAxisArray[1],
					e = b ? "distX" : "dist";
				b = -1 < d.options.findNearestPointBy.indexOf("y") ? 2 : 1;this.kdTree || this.buildingKdTree || this.buildKDTree();
		...
		a.StackItem.prototype = {
			...
			getStackBox : function(a, c, e, h, l, d, b) {
				...
				c = c.isNegative && !f || !c.isNegative && f;return {
					x : k ? c ? h : h - d : e,
		...
		C.prototype.renderStackTotals = function() {
			...
			h || (this.stackTotalGroup = h = c.g("stack-labels").attr({
				visibility : "visible",
				zIndex : 6
			}).add());h.translate(a.plotLeft, a.plotTop);y(e, function(a) {
				y(a, function(a) {
					a.render(h)
				})
			})
		...
		x.prototype.getStackIndicator = function(a, c, e, h) {
			...
			a.key = [ e, c, a.index ].join();return a
		}
	})(K);(function(a) {
		var C = a.addEvent,
			E = a.animate,
		...
		q(a.Chart.prototype, {
			addSeries : function(a, c, d) {
				...
				a && (c = b(c, !0), x(e, "addSeries", {
					...
					f = e.initSeries(a);
					e.isDirtyLegend = !0;e.linkSeries();x(e, "afterAddSeries");c && e.redraw(d)
				}));return f
			},
			addAxis : function(a, c, d, f) {
				...
				c = new F(this, a);
				h[e] = L(h[e] || {});h[e].push(a);b(d, !0) && this.redraw(f);return c
			},
			showLoading : function(a) {
				...
				b.loadingSpan.innerHTML = a || c.lang.loading;h(d, q(f.style, {
					zIndex : 10
				}));h(b.loadingSpan, f.labelStyle);b.loadingShown || (h(d, {
					opacity : 0,
					display : ""
				}), E(d, {
			...
			update : function(a, h, m, k) {
				...
				if (r) {
					l(!0, t.options.chart, r);"className" in r && t.setClassName(r.className);"reflow" in r && t.setReflow(r.reflow);
					if ("inverted" in r || "polar" in r || "type" in r) t.propFromSeries(), g = !0;
					"alignTicks" in r && (g = !0);d(r, function(a, b) {
				...
				a.colors && (this.options.colors = a.colors);a.plotOptions &&
				l(!0, this.options.plotOptions, a.plotOptions);d(a, function(a, b) {
					...
					a[b] && ("series" === b && (c = [], u(t[b], function(a, b) {
						...
						if (!d &&
							m)
							if ("series" === b)
								t.addSeries(a, !1).touched = !0;
							else if ("xAxis" === b || "yAxis" === b)
								t.addAxis(a, "xAxis" === b, !1).touched = !0
					}), m && u(t[b], function(a) {
				...
				g = r && r.width;
				r = r && r.height;
				c(g) && g !== t.chartWidth || c(r) && r !== t.chartHeight ? t.setSize(g, r, k) : b(h, !0) && t.redraw(k);x(t, "afterUpdate", {
					options : a
				})
			},
			...
			update : function(a, c, d, f) {
				function e() {
					h.applyOptions(a);null === h.y && g && (h.graphic = g.destroy());k(a, !0) && (g && g.element && a && a.marker && void 0 !== a.marker.symbol && (h.graphic = g.destroy()), a && a.dataLabels && h.dataLabel && (h.dataLabel = h.dataLabel.destroy()), h.connector && (h.connector = h.connector.destroy()));
					l = h.index;m.updateParallelArrays(h, l);
					p.data[l] = k(p.data[l], !0) || k(a, !0) ? h.options : b(a, p.data[l]);
					m.isDirty = m.isDirtyData = !0;!m.fixedBox &&
			...
			addPoint : function(a, c, d, f) {
				...
				if (this.requireSorting && n < p[r - 1])
					for (t = !0; r && p[r - 1] > n;) r--;
				this.updateParallelArrays(k, "splice", r, 0, 0);this.updateParallelArrays(k, r);g && k.name && (g[n] = k.name);l.splice(r, 0, a);t && (this.data.splice(r, 0, null), this.processData());"point" === e.legendType && this.generatePoints();d && (h[0] && h[0].remove ? h[0].remove(!1) : (h.shift(), this.updateParallelArrays(k, "shift"), l.shift()));
				this.isDirtyData = this.isDirty = !0;c && m.redraw(f)
			},
			removePoint : function(a, c, d) {
				var f = this,
					...
					g = f.chart,
					l = function() {
						m && m.length === e.length && m.splice(a, 1);e.splice(a, 1);f.options.data.splice(a, 1);f.updateParallelArrays(h || {
								series : f
							}, "splice", a, 1);h && h.destroy();
						f.isDirty = !0;
						f.isDirtyData = !0;c && g.redraw()
					};
				t(d, g);
				c = b(c, !0);
			...
			remove : function(a, c, d) {
				function f() {
					e.destroy();
					h.isDirtyLegend = h.isDirtyBox = !0;h.linkSeries();b(a, !0) && h.redraw(c)
				}
				var e = this,
					h = e.chart;
			...
			update : function(c, d) {
				...
				if (z) c.data && this.setData(c.data, !1), c.name && this.setName(c.name, !1);else {
					...
					I[p || t] ? q(e, I[p || t].prototype) : a.error(17, !0);u(v, function(a) {
						e[a] = v[a]
					});e.init(h, c);c.zIndex !== k.zIndex && u(n, function(a) {
						e[a] && e[a].attr({
							zIndex : c.zIndex
						})
					});
					e.oldType = t;h.linkSeries()
				}
			...
			update : function(a, c) {
				var f = this.chart,
					e = a && a.events || {};
				a = l(this.userOptions, a);f.options[this.coll].indexOf &&
				(f.options[this.coll][f.options[this.coll].indexOf(this.userOptions)] = a);d(f.options[this.coll].events, function(a, b) {
					"undefined" === typeof e[b] && (e[b] = void 0)
				});this.destroy(!0);this.init(f, q(a, {
					events : e
				}));
				f.isDirtyBox = !0;b(c, !0) && f.redraw()
			},
			remove : function(a) {
				for (var c = this.chart, d = this.coll, f = this.series, e = f.length; e--;) f[e] && f[e].remove(!1);
				y(c.axes, this);y(c[d], this);
				r(c.options[d]) ? c.options[d].splice(this.options.index, 1) :
					delete c.options[d];
				u(c[d], function(a, b) {
					a.options.index = a.userOptions.index = b
				});this.destroy();
				c.isDirtyBox = !0;b(a, !0) && c.redraw()
			},
		...
		e("area", "line", {
			...
			getStackPoints : function(e) {
				var h = [],
					...
					d = l.length,
					b,
					v = n(f.options.reversedStacks, !0) ? 1 : -1,
					p;
				e = e || this.points;
				if (this.options.stacking) {
					...
					b = F(l, function() {
						...
						if (k[a] && !k[a].isNull) h.push(k[a]), E([ -1, 1 ], function(f) {
							...
							l = f.translate(l, 0, 1, 0, 1);h.push({
								isNull : !0,
			...
			getGraphPath : function(a) {
				var e = h.prototype.getGraphPath,
					...
					L = function(c, e, h) {
						...
						var t,
							n,
							m = !0;
						h || k ? (t = (k ? c[0] : c[1]) + h, n = c[0] + h, m = !!k) : !u && a[e] && a[e].isNull && (t = n = p);void 0 !== t && (l.push({
							plotX : b,
				...
				a = a || this.points;u && (a = this.getStackPoints(a));
				...
				c = e.call(this, l, !0, !0);
				r.reversed = !0;
				k = e.call(this, r, !0, !0);k.length && (k[0] = "L");
				k = c.concat(k);
				e = e.call(this, l, !1, q);
				k.xMap = c.xMap;
				this.areaPath = k;return e
			},
			drawGraph : function() {
		...
		a = a.seriesType;a("spline", "line", {}, {
			getPointSpline : function(a, F, n) {
				...
				if (u && !u.isNull && !1 !== u.doCurve && !F.isCliff && n && !n.isNull && !1 !== n.doCurve &&
					...
					q = (1.5 * e + a) / 2.5;
					x = (1.5 * h + x) / 2.5;
					f = (1.5 * e + n) / 2.5;x !== y && (c = (f - q) * (x - h) / (x - y) + e - f);
					q += c;
					f += c;
				...
				u.rightContX = u.rightContY = null;return F
			}
		})
	})(K);(function(a) {
		...
		q("column", "line", {
			...
			crispCol : function(a, c, e, h) {
				var f = this.chart,
					...
					b = -(d % 2 ? .5 : 0),
					d = d % 2 ? .5 : 1;
				f.inverted && f.renderer.isVML && (d += 1);this.options.crisp && (e = Math.round(a + e) + b, a = Math.round(a) + b, e -= a);
				h = Math.round(c + h) + d;
				b = .5 >= Math.abs(c) && .5 < h;
				c = Math.round(c) + d;
			...
			translate : function() {
				...
				c.inverted && (b -= .5);e.pointPadding && (t = Math.ceil(t));y.prototype.translate.apply(a);F(a.points, function(f) {
					var e = u(f.yBottom, b),
						h = 999 + Math.abs(e),
			...
			pointAttribs : function(a, c) {
				...
				var d = l["stroke-width"] || "borderWidth",
					...
					l = f.dashStyle;
				a && this.zones.length && (b = a.getZone(), b = a.options.color || b && b.color || this.color);c && (a = e(f.states[c], a.options.states && a.options.states[c] || {}), c = a.brightness, b = a.color || void 0 !== c && E(b).brighten(a.brightness).get() ||
					b, n = a[h] || n, p = a[d] || p, l = a.dashStyle || l);
				h = {
					fill : b,
					stroke : n,
					"stroke-width" : p
				};l && (h.dashstyle = l);return h
			},
			drawPoints : function() {
				var a = this,
					c = this.chart,
				...
				F(a.points, function(b) {
					...
					if (h(b.plotY) && null !== b.y) {
						d = b.shapeArgs;
						if (f) f[p](e(d));else
							b.graphic = f = r[b.shapeType](d).add(b.group || a.group);
			...
			animate : function(a) {
				...
				x && (a ? (d.scaleY = .001, a = Math.min(f.pos + f.len, Math.max(f.pos, f.toPixels(e.threshold))), h ? d.translateX = a - f.len : d.translateY = a, c.group.attr(d)) : (q = c.group.attr(b), c.group.animate({
					...
					step : function(a, e) {
						d[b] = q + e.pos * (f.pos - q);c.group.attr(d)
					}
				})), c.animate = null))
			},
			remove : function() {
		...
		a = a.seriesType;a("bar", "column", null, {
			inverted : !0
		})
	})(K);(function(a) {
		var C = a.Series;
		a = a.seriesType;a("scatter", "line", {
			lineWidth : 0,
		...
		a.CenteredSeriesMixin = {
			...
			getStartAndEndRadians : function(a, e) {
				a = E(a) ? a : 0;
				e = E(e) && e > a && 360 > e - a ? e : a + 360;return {
					start : C * (a + -90),
					end : C * (e + -90)
				}
			}
		...
		c("pie", "line", {
			...
			translate : function(a) {
				...
				this.getX = function(b, c, d) {
					t = Math.asin(Math.min((b - a[1]) / (a[2] / 2 + d.labelDistance), 1));return a[0] + (c ? -1 : 1) * Math.cos(t) * (a[2] / 2 + d.labelDistance)
				};
				for (y = 0; y < C; y++) {
					G = u[y];
			...
			drawPoints : function() {
				var a = this,
					...
					e,
					k = a.options.shadow;
				k && !a.shadowGroup && (a.shadowGroup = c.g("shadow").add(a.group));n(a.points, function(l) {
					b = l.graphic;
					if (l.isNull) b && (l.graphic = b.destroy());else {
						e = l.shapeArgs;
						d = l.getTranslate();
						var t = l.shadowGroup;
						k && !t && (t = l.shadowGroup = c.g("shadow").add(a.shadowGroup));t && t.attr(d);
			...
			setVisible : function(a, c) {
				...
				c = q(c, e);a !== d.visible && (d.visible = d.options.visible = a = void 0 === a ? !d.visible : a, b.options.data[u(d, b.data)] = d.options, n([ "graphic", "dataLabel", "connector", "shadowGroup" ], function(b) {
			...
			slice : function(a,
				...
				b.options.data[u(this, b.data)] = this.options;this.graphic.animate(this.getTranslate());this.shadowGroup && this.shadowGroup.animate(this.getTranslate())
			},
		...
		c.prototype.drawDataLabels = function() {
			...
			if (l.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(l), D = b.plotGroup("dataLabelsGroup", "data-labels", B && !u ? "hidden" : "visible", l.zIndex || 6), B && (D.attr({
					...
					b.visible && D.show(!0);D[h.animation ? "animate" : "attr"]({
						opacity : 1
					}, {
						duration : 200
					})
		...
		c.prototype.justifyDataLabel = function(a, b, c, e, f, h) {
			...
			m = c.x + n;0 > m && ("right" === l ? b.align = "left" : b.x = -m, t = !0);
			m = c.x + e.width -
				n;m > d.plotWidth && ("left" === l ? b.align = "right" : b.x = d.plotWidth - m, t = !0);
			m = c.y + n;0 > m && ("bottom" === k ? b.verticalAlign = "top" : b.y = -m, t = !0);
			m = c.y + e.height - n;m > d.plotHeight && ("top" === k ? b.verticalAlign = "bottom" : b.y = d.plotHeight - m, t = !0);t && (a.placed = !h, a.align(b, null, f));return t
			...
			d.visible && (h.enabled || d._hasPointLabels) && (n(b, function(a) {
				...
				if (t)
					for (d.sortByAngle(b, c - .5), 0 < d.maxLabelDistance && (k = Math.max(0, G - C - d.maxLabelDistance), m = Math.min(G + C + d.maxLabelDistance, f.plotHeight), n(b, function(a) {
						...
						}), k = m + u - k, a.distribute(p, k, k / 5)), R = 0; R < t; R++) e = b[R], K = e.labelPos, g = e.dataLabel, z = !1 === e.visible ? "hidden" : "inherit", N = k = K[1], p && F(e.distributeBox) && (void 0 === e.distributeBox.pos ? z = "hidden" : (Q = e.distributeBox.size, N = e.top + e.distributeBox.pos)),
						delete e.positionIndex
						, O = h.justify ? y[0] + (c ? -1 : 1) * (C + e.labelDistance) : d.getX(N < e.top + 2 || N > e.bottom - 2 ? k : N, c, e), g._attr = {
							visibility : z,
							align : K[6]
						}, g._pos = {
							x : O + h.x + ({
			...
			e.verticalAlign = x(e.verticalAlign, d || m ? "middle" : n ? "top" : "bottom");c.prototype.alignDataLabel.call(this,
				a, b, e, f, h);a.isLabelJustified && a.contrastColor && a.dataLabel.css({
		...
		var C = a.Chart,
			...
			F = a.objectEach,
			n = a.pick;
		a = a.addEvent;a(C, "render", function() {
			var a = [];
		...
		C.prototype.hideOverlappingLabels = function(a) {
			...
			for (n = 0; n < e; n++)
				for (c = (q = a[n]) && q.absoluteBox, h = n + 1; h < e; ++h)
					if (f = (x = a[h]) && x.absoluteBox, c && f && q !== x && 0 !== q.newOpacity && 0 !== x.newOpacity && (f = k(c.x, c.y, c.width, c.height, f.x, f.y, f.width, f.height)))
						(q.labelrank < x.labelrank ?
							q : x).newOpacity = 0;
			E(a, function(a) {
				var c,
					d;
		...
		I = a.TrackerMixin = {
		...
		};v.column && (v.column.prototype.drawTracker = I.drawTrackerPoint);v.pie && (v.pie.prototype.drawTracker = I.drawTrackerPoint);v.scatter && (v.scatter.prototype.drawTracker = I.drawTrackerPoint);y(k.prototype, {
			setItemEvents : function(a, b, c) {
				var e = this,
					f = e.chart.renderer.boxWrapper,
					h = "highcharts-legend-" + (a instanceof d ? "point" : "series") + "-active";
				(c ? b : a.legendGroup).on("mouseover", function() {
					a.setState("hover");f.addClass(h);b.css(e.options.itemHoverStyle)
				}).on("mouseout", function() {
					b.css(r(a.visible ? e.itemStyle : e.itemHiddenStyle));f.removeClass(h);a.setState()
				}).on("click",
					function(b) {
						var c = function() {
			...
			createCheckboxForItem : function(a) {
				...
				}, this.options.itemCheckboxStyle, this.chart.container);C(a.checkbox, "click", function(b) {
		...
		h.legend.itemStyle.cursor = "pointer";y(E.prototype, {
			...
			zoom : function(a) {
				...
				e && !f ? this.showResetZoom() : !e && c(f) && (this.resetZoomButton = f.destroy());b && this.redraw(l(this.options.chart.animation, a && a.animation, 100 > this.pointCount))
			},
			pan : function(a, b) {
				var c = this,
					d = c.hoverPoints,
				...
				d && u(d, function(a) {
					...
					var d = b.horiz,
						...
						n = k - h;
					0 < n && (m += n, h = k);
					n = m - g;0 < n && (m = g, h -= n);b.series.length &&
					h !== l.min && m !== l.max && (b.setExtremes(h, m, !1, !1, {
						trigger : "pan"
					}), e = !0);
					c[d] = f
				});e && c.redraw(!1);n(c.container, {
					cursor : "move"
				})
			}
		});y(d.prototype, {
			select : function(a, b) {
				...
				a = l(a, !c.selected);c.firePointEvent(a ? "select" : "unselect", {
					...
					d.options.data[f(c, d.data)] = c.options;c.setState(a && "select");b || u(e.getSelectedPoints(), function(a) {
			...
			onMouseOver : function(a) {
				var b = this.series.chart,
					c = b.pointer;
				a = a ? c.normalize(a) : c.getChartCoordinatesFromPoint(this, b.inverted);c.runPointActions(a, this)
			},
			onMouseOut : function() {
				var a = this.series.chart;
				this.firePointEvent("mouseOut");u(a.hoverPoints || [], function(a) {
					a.setState()
				});
			...
			importEvents : function() {
				if (!this.hasImportedEvents) {
					...
					b.events = c;a.objectEach(c, function(a,
						c) {
						C(b, c, a)
					});
			...
			setState : function(a, b) {
				...
				if (!(a === this.state && !b || this.selected && "select" !== a || !1 === h.enabled || a && (g || n && !1 === p.enabled) || a && r.states && r.states[a] && !1 === r.states[a].enabled)) {
					...
					if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(f.pointAttribs(this, a), l(u.options.chart.animation, h.animation)), x && this.graphic.animate(x, l(u.options.chart.animation, p.animation, k.animation)), t && t.hide();else {
						if (a && p) {
							k = r.symbol || f.symbol;t && t.currentSymbol !== k && (t = t.destroy());
					...
					this.state = a;q(this, "afterSetState")
				}
			},
			haloPath : function(a) {
			...
			onMouseOver : function() {
				...
				this.options.events.mouseOver && q(this, "mouseOver");this.setState("hover");
				a.hoverSeries = this
			},
			onMouseOut : function() {
				var a = this.options,
				...
				b.hoverSeries = null;
				if (d) d.onMouseOut();
				this && a.events.mouseOut && q(this, "mouseOut");!c || this.stickyTracking || c.shared && !this.noSharedTooltip || c.hide();this.setState()
			},
			setState : function(a) {
				var b = this,
					c = b.options,
			...
			setVisible : function(a, b) {
				var c = this,
					...
					k = c.visible;
				f = (c.visible = a = c.options.visible = c.userOptions.visible = void 0 === a ? !k : a) ? "show" : "hide";u([ "group", "dataLabelsGroup", "markerGroup", "tracker", "tt" ],
					function(a) {
						if (c[a]) c[a][f]()
					});
				if (d.hoverSeries === c || (d.hoverPoint && d.hoverPoint.series) === c) c.onMouseOut();
				e && d.legend.colorizeItem(c, a);
				c.isDirty = !0;c.options.stacking && u(d.series, function(a) {
					a.options.stacking && a.visible && (a.isDirty = !0)
				});u(c.linkedSeries, function(b) {
					b.setVisible(a, !1)
				});h && (d.isDirtyBox = !0);q(c, f);!1 !== b && d.redraw()
			},
			show : function() {
				this.setVisible(!0)
			},
			...
			function q(e, c, k, r) {
				...
				a.objectEach(e, function(a, b) {
					if (!r && -1 < F(b, [ "series", "xAxis", "yAxis" ]))
						...
						h(a) ? (k[b] = n(a) ? [] : {}, q(a, c[b] || {}, k[b], r + 1)) : k[b] = c[b] || null
				})
			}
			var x = {};
			q(e, this.options, x, 0);return x
		}
	})(K);return K
});